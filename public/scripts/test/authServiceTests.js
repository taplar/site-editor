describe( "AuthService", function() {
	...
	describe( "ProcessValidate", function() {
		...
		it( "Should throw error if response code not returned", function() {
			authService.processValidate( JSON.stringify( jsonObject ) );
	...
	describe( "ProcessDisplayLogin", function() {
		...
		it( "Should build login and bind actions", function() {
			var minimalPrompt = $( "<div>", { class: "prompt-container" } )
				.append(
					$( "<div>", { class: "prompt" } )
			...
			authService.processDisplayLogin( minimalPrompt );
	...
	describe( "ProcessLoginSubmit", function() {
		...
		it( "Should throw error if response code not returned", function() {
			authService.processLoginSubmit( JSON.stringify( jsonObject ) );
	...
	describe( "ProcessLogout", function() {
		...
		it( "Should throw error if response code not returned", function() {
			authService.processLogout( JSON.stringify( jsonObject ) );
